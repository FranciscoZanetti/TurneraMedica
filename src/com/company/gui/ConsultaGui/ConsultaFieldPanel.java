...
public class ConsultaFieldPanel extends JPanel{
    ...
    public ConsultaFieldPanel(String title, String field){
        ...
        if (title == "Hora"){
            ...
            setPreferredSize(new Dimension(152, 72));
            setMaximumSize(new Dimension(152, 72));
        }
//        setPreferredSize(new Dimension(145, 72));
        ...
        fieldLabel.setMaximumSize(new Dimension(132, 14));
        
        titleLabel.setFont(new Font("Roboto Light", 0, 14));
        fieldLabel.setFont(new Font("Roboto Medium", 0, 14));
